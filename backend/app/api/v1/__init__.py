...
from app.api.v1.endpoints import stats, auth, finance, bot, import_data, stores, export, agent, agent_config
...
router.include_router(agent.router, prefix="/agent", tags=["掌舵Agent"])
router.include_router(agent_config.router, prefix="/agent/config", tags=["掌舵配置"])
